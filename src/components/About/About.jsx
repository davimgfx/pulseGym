        ...
        <div className="container page-padding">
          <div
            ...
            <div className="md1200:items-center md1200:flex md1200:flex-col md1200:text-center md1200:w-[full] ">
              ...
              <div className="flex gap-[2rem] text-[26px] mt-[4rem] mb-[4rem] min540:hidden md1200:items-center md1200:flex md1200:text-center">
                <div className="flex flex-col justify-center items-center gap-3">
                  <i class="fa-solid fa-dumbbell text-[4.5rem] mb-[0.1rem] min800:text-[4rem]"></i>
                  <p className="text-[22px] text-center text-black font-bold min800:text-[20px] leading-tight">
                    Modern <br />
                    Equipaments
                  </p>
                </div>
                <div className="flex flex-col justify-center items-center border-solid border-l border-[rgb(0,0,0,0.2)] border-r px-[3.5rem] gap-[1.3rem] text-[26px] mb-[2rem] ">
                  <i class="fa-solid fa-basketball text-[4.5rem] min800:text-[4rem]"></i>
                  <p className="text-[22px] text-center text-black font-bold min800:text-[20px]">
                    Sports
                  </p>
                </div>
                <div className="flex flex-col justify-center items-center gap-3">
                  <i class="fa-regular fa-user text-[4.5rem] mb-[0.1rem] font-thin min800:text-[4rem]"></i>
                  <p className="text-[22px] text-center text-black font-bold min800:text-[20px] leading-tight">
                    Skilled <br />
                    professionals
                  </p>
