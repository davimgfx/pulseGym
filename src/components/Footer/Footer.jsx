...
const Footer = () => {
  return (
    <section
      className="mt-[2rem] flex justify-center min375:px-[0.2rem]"
      id="footer">
      <div className="px-[2rem] flex justify-center gap-[25rem] md1300:gap-[15rem] mb-[5rem] md1000:flex-col md1000:gap-[2rem]">
        ...
        <div>
          ...
          <div className="h-[0.5rem] bg-[#fffb03] my-[0.1rem] rounded transform translate-x-2 max-w-[9rem]"></div>
          <div className="card-top p-[1rem] h-[17rem] min620:h-[14rem] md1000:mb-[10rem] min620:mb-[15rem]">
            {navLinks.map((item, index) => (
              <Link to={item.path} key={index}>
                <p className="mt-[1.5rem] text-[16px] hover:font-bold cursor-pointer duration-500 ease">
                  {item.title}
                </p>
              </Link>
            ))}
        ...
        <div className="">
          ...
          <div className="h-[0.5rem] bg-[#fffb03] my-[0.1rem] rounded transform translate-x-2 max-w-[9rem] "></div>
          <div className="mt-[3rem] flex align-center justify-start gap-[2rem] ">
